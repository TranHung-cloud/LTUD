...
namespace LTUD
{
    public partial class QuanLyPhuongPhapKhauHao : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (txtTyLe.Text == "")
            {
                MessageBox.Show("Vui lòng nhập tỷ lệ khấu hao");
                return;
            }
            if (float.TryParse(txtTyLe.Text, out float tyLeValue) && tyLeValue >= 100)
            {
                MessageBox.Show("Lỗi: 'Tỷ lệ khấu hao' không được lớn hơn 100!", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtTyLe.Focus();
                return;
            }
